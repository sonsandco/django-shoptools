    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'New'), (3, 'Processing'), (2, 'Payment Failed'), (4, 'Shipped')], default=1)),
